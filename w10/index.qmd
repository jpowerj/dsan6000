...
## `Task` vs. `Operator`: A Sanity-Preserving (More than Technical) Distinction {.title-08 .crunch-title .crunch-blockquote .text-90 .crunch-quarto-figure}
...
![](images/data-x-crop-2.jpeg){fig-align="center" width="70%"}
...
``` {.bash filename="start-airflow.sh" code-line-numbers="|1|2|3|4|5"}
airflow db migrate
