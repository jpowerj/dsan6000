...
The class meeting on <b><span class='sec-date-full'>Monday, November 2</span></b> will be an **in-class, on-paper midterm**. Details can be found on the [Midterm page]() (also accessible via the site sidebar to the left).