...
## Samyu Vakkalanka, [`spv15@georgetown.edu`](mailto:spv15@georgetown.edu) {.smaller .title-12}
...
* The [Google Space]({{< var gspace_url >}}){target='_blank'} is the primary form of communication for **general questions**
...
* (But, consider the GSpace first: most questions last year were issues faced by multiple students!)
