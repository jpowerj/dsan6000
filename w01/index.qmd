...
| **Break!** | 8:00pm | 8:10pm | |
| | 8:10pm | 9:00pm | [In-Class Demo: DDLs and DQLs &rarr;](#lab-ddls-vs.-dqls)
...
<tr>
  ...
  <td class='tdvc'><span data-qmd="**The Zilliz Course**: @zilliz_introduction_2025, *Introduction to Unstructured Data*"></span></td>
</tr>
</tbody>
</table>
```

# Time for In-Class Demos! {data-stack-name="Demos"}
